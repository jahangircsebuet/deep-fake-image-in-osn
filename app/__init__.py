...
from app.models import db, User, Friend, Post, Comment, Like
...
from app.api.aws_routes import aws_routes
from app.api.friend_routes import friend_routes
from app.api.profile_routes import profile_routes
from app.api.like_routes import like_routes
from app.api.qa_routes import qa_routes
